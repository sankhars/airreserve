package alti.san.airbooking.controller;


import alti.san.airbooking.model.*;
import alti.san.airbooking.repository.FlightRepository;
import alti.san.airbooking.repository.PassengerRepository;
import alti.san.airbooking.repository.ReservationRepository;
import alti.san.airbooking.model.*;
import alti.san.airbooking.model.*;
import alti.san.airbooking.utils.DateTimeUtil;
import alti.san.airbooking.utils.IntervalStartComparator;
...
public class ReservationController {
    ...
    public ResponseEntity<?> createReservation(@RequestParam(value = "passengerId") String passengerId,
        ...
        for (Flight flight : passengerPreviousFlights) {
            String airplaneName= String.valueOf(flight.getPlane());
            // compute interval
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd-hh", Locale.US);
            try {
                Date departureDateTime = simpleDateFormat.parse(flight.getDepartureTime());
    ...
    public ResponseEntity<?> searchReservation(@RequestParam(value = "price", required = false) String price,
                                               @RequestParam(value = "no_stops", required = false) String no_stops,
                                               ...
                                               @RequestParam(value = "airplaneName", required = false) String airplaneName,
                                               @RequestParam(value = "duration", required = false) String duration,
                                               @RequestParam(value = "totalresults", required = false) String totalresults,
        ...
        List<Reservation> reservations = reservationRepository.searchForReservations(flightNumber, price,
                airplaneName,departureDateTime,
                arrivalDateTime,duration,
                no_stops,totalresults);
