...
public class FlightController {
     ...
     * @param traveldate     the departure time
     * @param returndate       the arrival time
    ...
    public ResponseEntity<?> createOrUpdateFlight(@PathVariable("flightNumber") String flightNumber,
        ...
        // save to db
        Flight flightObjFromDb = flightRepository.save(new Flight(flightNumber, price, sourcecity
                ,destination, traveldate,
                returndate, description, seatsLeft, new Plane(capacity, model, manufacturer, yearOfManufacture)));
